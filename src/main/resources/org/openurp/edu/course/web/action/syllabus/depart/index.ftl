...
<div class="search-container">
  <div class="search-panel">
    [@b.form name="courseTaskSearchForm" action="!search" target="courseTaskList" title="ui.searchForm" theme="search"]
      ...
      [@b.select name="hasTopics" label="教学主题" items={"1":"有", "0":"无"} empty="..." /]
      [@b.select name="syllabus.complete" label="是否完整" items={"1":"是", "0":"否"} empty="..." /]
      [@b.select name="reuse" label="修订情况" items={"1":"沿用", "0":"新修订"} empty="..." /]

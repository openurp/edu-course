...
<div class="border-colored border-1px border-0px-tb" style="margin-bottom:20px">
  [@b.form theme="list" action="!saveTextbook"]
    ...
    [@b.textarea name="syllabus.bibliography" label="参考书目" value=syllabus.bibliography! required="false" rows="4" cols="80" maxlength="2000" /]
    [@b.textarea name="syllabus.materials" label="其他教学资源" value=syllabus.materials! required="false" rows="4" cols="80" maxlength="2000" /]

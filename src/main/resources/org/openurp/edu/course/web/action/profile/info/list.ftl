    ...
    <div class="card-header">
      ...
      [@b.form name="courseSearchForm" action="!search" class="form-inline ml-3 float-right" ]
        ...
        <div id="hasClassFilters" class="btn-group btn-group-toggle" data-toggle="buttons" style="height: 30px;margin: 0px 5px 0px 5px;">
            ...
            <input type="radio" name="hasClazz" value="" [#if hasClazz=='-']checked="checked"[/#if]>全部
            </label>
            ...
            <input type="radio" name="hasClazz" value="1" [#if hasClazz=='1']checked="checked"[/#if]> 已开课
            </label>
            <label style="font-size:0.8125rem !important;padding:2px 8px 0px 8px;" class="btn btn-outline-secondary btn-sm [#if hasClazz=='5'] active[/#if]">
            <input type="radio" name="hasClazz" value="5" [#if hasClazz=='5']checked="checked"[/#if]> 近五年开课
            </label>
            <label style="font-size:0.8125rem !important;padding:2px 8px 0px 8px;" class="btn btn-outline-secondary btn-sm [#if hasClazz=='-5'] active[/#if]">
            <input type="radio" name="hasClazz" value="-5" [#if hasClazz=='-5']checked="checked"[/#if]> 近五年未开课
            </label>
            ...
            <input type="radio" name="hasClazz" value="0" [#if hasClazz=='0']checked="checked"[/#if]> 从未开课
            </label>
        </div>
      [/@]
    </div>

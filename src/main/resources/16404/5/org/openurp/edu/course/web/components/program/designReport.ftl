...
<div class="container">
  ...
  <table class="grid-table">
    ...
    <tr><td class="title">教学目标</td><td colspan="2">${design.get('target')!}</td></tr>
    <tr><td class="title">教学重点</td><td colspan="2">${design.get('emphasis')!}</td></tr>
    <tr><td class="title">教学难点</td><td colspan="2">${design.get('difficulties')!}</td></tr>
    <tr><td class="title">教学资源</td><td colspan="2">${design.get('resources')!}</td></tr>
    <tr><td class="title">课程思政融入点</td><td colspan="2">${design.get('values')!}</td></tr>
    ...
    <tr><td>课后作业</td><td colspan="2">${design.homework!}</td></tr>
  </table>
</div>
[@b.foot/]
